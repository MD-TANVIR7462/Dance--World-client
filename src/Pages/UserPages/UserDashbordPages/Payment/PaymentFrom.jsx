...
const PaymentFrom = ({ price, newPay }) => {
  ...
  return (
    <form
      ...
      className="w-full  max-w-2xl mx-auto bg-cyan-800 p-8 rounded-lg shadow-lg"
    >
      <div className=" mx-auto mb-6 max-w-xl">
        {" "}
        {/* Set a specific width for the card container */}
        <CardElement
          options={{
            style: {
              base: {
      ...
      {cardError && (
        <p className="text-red-800 mt-4 text-center">{cardError}</p>
      )}
      {tranjectionID && (
