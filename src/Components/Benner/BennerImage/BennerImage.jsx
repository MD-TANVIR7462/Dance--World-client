...
const BannerImage = ({ imageUrl, title, subtitle }) => {
   ...
   return (
      <div className="hero min-h-[720px] bg-gradient-to-r from-pink-500 to-violet-500">
         <div className="hero-content flex  pb-32  pt-48 gap-32 flex-col md:flex-row-reverse">
            <motion.img
               ...
               src={imageUrl}
               alt="Shool-Banner"
               className="w-[650px] transition-transform hover:scale-105 rounded-lg shadow-3xl hero-overlay opacity-95  "
            ...
            <div className="flex flex-col justify-center">
               ...
               <motion.p
                  className="pt-3 pb-5 text-white"
                  data-aos="fade-right"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="1000"
               >
